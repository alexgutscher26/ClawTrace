                    ...
                    <CardContent className="space-y-6">
                        <div className="rounded-none border border-white/10 bg-black/50 p-4 font-mono">
                            ...
                            <div className="mt-4 border-t border-white/10 pt-4 flex items-center justify-between">
                                ...
                                <span className="text-2xl font-black text-emerald-400 font-mono">$99.00</span>
                            </div>
                        </div>

                        <div className="space-y-3 text-[10px] text-zinc-500 font-mono uppercase leading-relaxed">
