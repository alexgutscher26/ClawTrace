 ...
 *
 * This component fetches agent details using the provided API and agentId, manages loading and restarting states,
 * and allows for configuration editing and saving. It utilizes various hooks such as useState and useEffect
 * to manage state and side effects, and handles errors gracefully with user notifications.
 *
