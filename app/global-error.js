                ...
                <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-6 font-mono tracking-tight">
                    ...
                    <main className="relative z-10 w-full max-w-lg">
                        ...
                        <div className="mb-8 border-l-4 border-red-600 bg-red-950/20 p-6 backdrop-blur-sm">
                            <h1 className="mb-2 text-2xl font-black uppercase tracking-tighter text-red-500">
                                System Kernel Panic
                            </h1>
                            <p className="text-sm font-medium leading-relaxed text-zinc-400">
                                The root coordinator has crashed. High-level routing and state management
                                have been suspended to protect fleet data integrity.
                            </p>
                        </div>

                        {/* Diagnostic Box */}
                        <div className="mb-12 rounded-lg border border-zinc-800 bg-black/80 p-6 shadow-2xl backdrop-blur-xl">
                            <div className="mb-4 flex items-center justify-between text-[10px] uppercase tracking-widest text-zinc-600">
                                <span>Core Error Log</span>
                                <span className="h-1.5 w-1.5 rounded-full bg-red-500 animate-pulse" />
                            </div>
                            <div className="max-h-[200px] overflow-y-auto text-xs leading-relaxed text-zinc-300 scrollbar-thin scrollbar-thumb-zinc-800">
                    ...
                    <div className="pointer-events-none fixed inset-0 z-50 opacity-[0.07]"
