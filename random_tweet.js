...
const bugs = [
  'a race condition in the heartbeat loop',
  'a memory leak in the parser',
  'an infinite recursion in tool calling',
  'a WebSocket timeout issue',
  'a weird edge case with emojis',
  'a timezone parsing error',
];
