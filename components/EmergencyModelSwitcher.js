        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="border-red-500/30 bg-black shadow-2xl shadow-red-500/10">
                <DialogHeader>
                    ...
                    <DialogTitle className="text-center text-xl font-bold text-red-500 uppercase tracking-widest">
                ...
                <div className="my-6 space-y-4 rounded-lg border border-red-500/20 bg-red-500/5 p-4">
                    ...
                    <div className="flex items-center gap-2 rounded bg-black/40 p-3 text-xs text-zinc-400">
                        ...
                        <span>
                            Action will be applied to <strong>ALL agents</strong> matching 'From'. Agents will update on next heartbeat.
                        </span>
                    </div>
                </div>
                ...
                <DialogFooter className="sm:justify-center">
                    <Button
                        variant="destructive"
                        className="w-full bg-red-600 hover:bg-red-700 font-bold tracking-wider"
