...
import { CreditCard, Settings, Server, LayoutDashboard, FileText, LogOut } from 'lucide-react';
        ...
        <CommandGroup heading="Agents">
          {agents.map((agent) => (
            ...
            >
              ...
              <span className="text-muted-foreground ml-auto text-xs">{agent.status}</span>
            </CommandItem>
          ))}
          {agents.length === 0 && <CommandItem disabled>No agents found</CommandItem>}
        </CommandGroup>
