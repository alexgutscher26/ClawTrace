 ...
 *
 * The function first checks if a custom policy object is provided and matches the given ID. If so, it returns the custom policy's properties. If not, it retrieves the built-in policy from POLICY_PROFILES, defaulting to the dev profile if the ID is not found.
 *
