...
/**
 * Checks for stale agents and updates their status to offline.
 *
 * This function calculates a threshold time of five minutes ago and queries the database for agents that are currently 'online' but have not sent a heartbeat since that time. If any agents are found, their status is updated to 'offline', and alerts are triggered for each updated agent. Errors during alert processing are logged to prevent interruption of the loop.
 *
